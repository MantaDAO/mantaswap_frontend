import { Kuji } from '@/app/components/icons/_tokens/kuji';
import { OSMO } from '@/app/components/icons/_tokens/IconOSMO';
import { IconAtom } from '@/app/components/icons/_tokens/IconAtom';
import { SCRT } from '@/app/components/icons/_tokens/IconSCRT';
import { IconJUNO } from '@/app/components/icons/_tokens/IconJUNO';
import { STARS } from '@/app/components/icons/_tokens/IconSTARS';
import IconSTRD from '@/app/components/icons/_tokens/IconSTRD';
...
export const getBridgeDenomByCode = (chain: any, code: any) => {
  for (const token of chain.bridgeTokens) {
    if (token.code === code) {
      for (const hop of token.route) {
        if (hop.chainId == chain.chainId) {
          return hop;
        }
      }
    }
